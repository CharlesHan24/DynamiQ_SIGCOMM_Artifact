...
def select_comm_hook(aggregation_method):
    ...
    raise ValueError(
        "Unsupported aggregation_method for train_llm_maskedlm_bert.py. "
...
if __name__ == "__main__":
    ...
    ddp_kwargs = DistributedDataParallelKwargsCustom(
        bucket_cap_mb=4000 if "dynamiq" in args.aggregation_method.lower() else 256,
        comm_hook=comm_hook,
    ...
    lr_scheduler, lr_decay_steps = build_lr_scheduler(optimizer, num_update_steps_per_epoch)
